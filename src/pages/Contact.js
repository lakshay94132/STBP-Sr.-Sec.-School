        ...
        <div className="row g-5 align-items-center mb-5">
          ...
          <div className="col-lg-6">
            <div className="contact-card p-4 rounded-4 shadow-lg glass-box">
              ...
              <p>
                <strong>📍 Address:</strong> Near Ayurvedic Hospital, Ward No.
                6, Jandawali, Hanumangarh (335512), Rajasthan
              </p>
              <p>
                <strong>📞 Phone:</strong>
                <br /> +91 99291-42063
              ...
              <p>
                <strong>📧 Email:</strong> STBPSchool@gmail.com
              </p>
              <p>
                <strong>🕗 Timings:</strong>
                <br />
                Summer: 8:00 AM – 2:00 PM
                <br />
            ...
            <div className="row g-4">
              <div className="col-md-6">
                <input
                  ...
                  className="form-control form-control-lg input-glass"
              ...
              <div className="col-12 text-center">
                <button type="submit" className="btn btn-neon btn-lg px-5 mt-2">
                  Send Message
                </button>
              </div>
            </div>
